...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="display fullscreen grid",
    )
    parser.add_argument(
        "-n",
        type=int,
        metavar="initial_points",
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="traditional mode",
    )
    parser.add_argument(
        "-x", "--no-hud", action="store_true", default=False, help="don't display HUD"
    )
    parser.add_argument(
        "--test", action="store_true", default=False, help=argparse.SUPPRESS
    )
